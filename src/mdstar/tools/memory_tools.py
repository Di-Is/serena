...
from mdstar.tools import TOOL_DEFAULT_MAX_ANSWER_LENGTH, Tool


class WriteMemoryTool(Tool):
    """
    Writes a named memory (for future reference) to Mdstar's project-specific memory store.
    """
...
class ReadMemoryTool(Tool):
    """
    Reads the memory with the given name from Mdstar's project-specific memory store.
    """
...
class ListMemoriesTool(Tool):
    """
    Lists memories in Mdstar's project-specific memory store.
    """
...
class DeleteMemoryTool(Tool):
    """
    Deletes a memory from Mdstar's project-specific memory store.
    """
