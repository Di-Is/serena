...
from mdstar.tools.tools_base import ToolMarkerOptional
...
class RestartLanguageServerTool(Tool, ToolMarkerOptional):
    """Restarts the language server, may be necessary when edits not through Mdstar happen."""
