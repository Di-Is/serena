...
from mdstar.symbol import LanguageServerSymbol, LanguageServerSymbolRetriever, PositionInFile, Symbol

from solidlsp import SolidLanguageServer
from solidlsp.ls import LSPFileBuffer

if TYPE_CHECKING:
    from .agent import MdstarAgent
...
class CodeEditor(Generic[TSymbol], ABC):
    def __init__(self, project_root: str, agent: Optional["MdstarAgent"] = None) -> None:
...
class LanguageServerCodeEditor(CodeEditor[LanguageServerSymbol]):
    def __init__(self, symbol_retriever: LanguageServerSymbolRetriever, agent: Optional["MdstarAgent"] = None):
