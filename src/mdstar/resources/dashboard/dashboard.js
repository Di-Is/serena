...
class Dashboard {
    ...
    initializeTheme() {
        ...
        const savedTheme = localStorage.getItem('mdstar-theme');
    ...
    toggleTheme() {
        ...
        localStorage.setItem('mdstar-theme', newTheme);
        this.setTheme(newTheme);
    }
    ...
    setTheme(theme) {
        ...
        localStorage.setItem('mdstar-theme', theme);
    ...
    updateLogo(theme) {
        const logoElement = document.getElementById('mdstar-logo');
        if (logoElement) {
            if (theme === 'dark') {
                logoElement.src = 'mdstar-logs-dark-mode.png';
            } else {
                logoElement.src = 'mdstar-logs.png';
            }
        }
    }
    ...
    shutdown() {
        ...
        if (confirm("This will fully terminate the Mdstar server.")) {
            _shutdown();
        } else {
