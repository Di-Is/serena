...
from mdstar.constants import PROMPT_TEMPLATES_DIR_IN_USER_HOME, PROMPT_TEMPLATES_DIR_INTERNAL
from mdstar.generated.generated_prompt_factory import PromptFactory


class MdstarPromptFactory(PromptFactory):
    """
