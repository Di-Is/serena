...
from mdstar.analytics import ToolUsageStats
from mdstar.constants import MDSTAR_DASHBOARD_DIR
...
class MdstarDashboardAPI:
    ...
    def _setup_routes(self) -> None:
        ...
        def serve_dashboard(filename: str) -> Response:
            return send_from_directory(MDSTAR_DASHBOARD_DIR, filename)

        @self._app.route("/dashboard/")
        def serve_dashboard_index() -> Response:
            return send_from_directory(MDSTAR_DASHBOARD_DIR, "index.html")
