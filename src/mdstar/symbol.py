...
class LanguageServerSymbolLocation:
    """
    Represents the (start) location of a symbol identifier, which, within Mdstar, uniquely identifies the symbol.
    """
...
class LanguageServerSymbolRetriever:
    def __init__(self, lang_server: SolidLanguageServer, agent: Union["MdstarAgent", None] = None) -> None:
        """
