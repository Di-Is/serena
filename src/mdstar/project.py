...
from mdstar.config.mdstar_config import DEFAULT_TOOL_TIMEOUT, ProjectConfig
from mdstar.constants import MDSTAR_MANAGED_DIR_IN_HOME
from mdstar.text_utils import MatchedConsecutiveLines, search_files
from mdstar.util.file_system import GitignoreParser, match_path
...
class Project:
    ...
    def create_language_server(
        ...
        return SolidLanguageServer.create(
            ...
            self.project_root,
            timeout=ls_timeout,
            solidlsp_settings=SolidLSPSettings(solidlsp_dir=MDSTAR_MANAGED_DIR_IN_HOME),
        )
