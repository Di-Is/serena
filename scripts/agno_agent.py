...
from mdstar.agno import MdstarAgnoAgentProvider
...
# is extended by MdstarAgentProvider, we must handle this here conditionally)
...
app = Playground(agents=[MdstarAgnoAgentProvider.get_agent(model)]).get_app()
