...
Agno is a model-agnostic agent framework that allows you to turn Mdstar into an agent 
...
easy it is to integrate Mdstar into an arbitrary agent framework.
...
2. Install mdstar with the optional requirements:
   ```shell
...
Here is a short demo of Mdstar performing a small analysis task with the newest Gemini model:
...
You may choose to disable certain tools for your setup in your Mdstar project's
configuration file (`.yml`).


## Other Agent Frameworks

It should be straightforward to incorporate Mdstar into any
...
Typically, you need only to write an adapter for Mdstar's tools to the tool representation in the framework of your choice, 
as was done by us for Agno with [MdstarAgnoToolkit](/src/mdstar/agno.py).
