...
import pytest
from mdstar.text_utils import LineType, search_files, search_text
...
class TestSearchFiles:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ["src/mdstar/agent.py", "src/mdstar/process_isolated_agent.py", "test/agent.py"],
                "match",
                "src/**agent.py",
                None,
                ["src/mdstar/agent.py", "src/mdstar/process_isolated_agent.py"],
                "Glob: src/**agent.py should match files ending with agent.py under src/",
            ),
            (
                ["src/mdstar/agent.py", "src/mdstar/process_isolated_agent.py", "other/agent.py"],
                "match",
                "**agent.py",
                None,
                ["src/mdstar/agent.py", "src/mdstar/process_isolated_agent.py", "other/agent.py"],
            ...
            (
                ["agent.py", "src/agent.py", "src/mdstar/agent.py"],
                "match",
                "**agent.py",
                None,
                ["agent.py", "src/agent.py", "src/mdstar/agent.py"],
...
class TestGlobMatch:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("**agent.py", "src/mdstar/agent.py", True),
            ("**agent.py", "src/mdstar/process_isolated_agent.py", True),
            ("**agent.py", "agent_test.py", False),
            # Prefix with double asterisk
            ("src/**agent.py", "src/agent.py", True),
            ("src/**agent.py", "src/mdstar/agent.py", True),
            ("src/**agent.py", "src/mdstar/process_isolated_agent.py", True),
    ...
    def test_glob_match(self, pattern, path, expected):
        ...
        from src.mdstar.text_utils import glob_match
