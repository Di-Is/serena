"""Tests for the mcp.py module in mdstar."""

import pytest
from mcp.server.fastmcp.tools.base import Tool as MCPTool
from mdstar.agent import Tool, ToolRegistry
from mdstar.config.context_mode import MdstarAgentContext
from mdstar.mcp import MdstarMCPFactory

make_tool = MdstarMCPFactory.make_mcp_tool
...
class MockAgent:
    def __init__(self):
        ...
        self.mdstar_config = None

    @staticmethod
    def get_context() -> MdstarAgentContext:
        return MdstarAgentContext.load_default()
