...
import pytest
from mdstar.config.mdstar_config import ProjectConfig
...
class TestProjectConfigAutogenerate:
    ...
    def test_autogenerate_empty_directory(self):
        ...
        assert "To use Mdstar with this project" in error_message
        ...
        assert str(Path(".mdstar") / "project.yml") in error_message
...
This is a test.""")
        ...
        config_path = self.project_path / ".mdstar" / "project.yml"
